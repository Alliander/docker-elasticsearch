...
# based on https://github.com/pires/docker-elasticsearch/blob/master/run.sh

BASE=/elasticsearch

# allow for memlock ->  should go to init container
#ulimit -l unlimited 
...
# plugins should be installed via docker baking
